...
#include "../../../../../../usr/lib/gcc/arm-none-eabi/10.3.1/include/float.h"
#include "../../../../../../usr/lib/arm-none-eabi/include/math.h"
#include "mjson.h"
...
#include "../../../../../../usr/lib/arm-none-eabi/include/stdio.h"
...
enum mjson_tok mjson_find(const char *s, int len, const char *jp, const char **tokptr, int *toklen) {
...
void
jsonrpc_ctx_process(struct jsonrpc_ctx *ctx, const char *buf, int len, mjson_print_fn_t fn, void *fndata, void *ud) {
